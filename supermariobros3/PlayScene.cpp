...
void CPlayScene::_ParseSection_OBJECTS(string line)
{
	...
	case OBJECT_TYPE_GOOMBA:
	{
		...
		obj = new CGoomba(x, y, state, type);
		break;
	}
	case OBJECT_TYPE_KOOPA: obj = new CKoopas(x, y); break;
	...
	case OBJECT_TYPE_FIRE_PIRANHAPLANT:
	{

		int tag = (int)atoi(tokens[3].c_str());
		obj = new PiranhaPlantFire(x, y, tag);
...
void CPlayScene::Update(DWORD dt)
{
	...
	if (CGame::GetInstance()->IsPaused()) dt = 0;
