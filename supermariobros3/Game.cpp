...
void CGame::Init(HWND hWnd, HINSTANCE hInstance)
{
	...
	// The DXGI will then calculate proper values automatically.
	// https://docs.microsoft.com/en-us/windows/win32/direct3darticles/dxgi-best-practices?redirectedfrom=MSDN
